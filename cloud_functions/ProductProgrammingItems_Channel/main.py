            ...
            for programming in programming_list:
                ...
                for items in items_list:
                    ...
                    row = {
                        ...
                        "CHANNEL_INITIALS": channel.get("initials") if isinstance(channel, dict) else None,
                    }
                    rows.append(row)
...
def loadBigquery(df, table_id):
    ...
    try:
        ...
        schema = [
            ...
            bigquery.SchemaField("CHANNEL_ID", "INT64"),
            bigquery.SchemaField("CHANNEL_NAME", "STRING"),
            bigquery.SchemaField("CHANNEL_INITIALS", "STRING"),
        ]
...
def main(request):
    ...
    table_id = os.environ.get('TABLE_ID_PROGRAMMING_ITEMS_CHANNEL')
