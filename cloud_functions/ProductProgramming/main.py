...
def extract(url, startDate, endDate, websiteId):
    try:
        ...
        for product in products:
            ...
            for programming in programming_list:
                row = {
                    ...
                    "PROGRAMMING_REGISTER_DATE": programming.get("registerDate"),
                    "PROGRAMMING_START": programming.get("start"),
                    "PROGRAMMING_END": programming.get("end"),
                    "PROGRAMMING_ITEMS_COUNT": len(programming.get("items", []))
                }
                rows.append(row)
        ...
        date_columns = ["PROGRAMMING_REGISTER_DATE", "PROGRAMMING_START", "PROGRAMMING_END"]
...
def main(request):
    ...
    table_id = os.environ.get('TABLE_ID_PROGRAMMING')
